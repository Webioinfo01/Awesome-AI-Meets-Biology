<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/papers-443-0EA5E9?style=flat-square" alt="Papers">
...
All 443 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:

**→ http://awesomebio.webioinfo.top/**

- 🌟 [AI Agents](http://awesomebio.webioinfo.top/#ai-agents) — 141 papers
...
- 📊 [Benchmarks](http://awesomebio.webioinfo.top/#benchmarks) — 54 papers
- 📚 [Reviews](http://awesomebio.webioinfo.top/#reviews) — 68 papers

Machine-readable data: [`docs/data.json`](docs/data.json) — 443 entries with full metadata (team, affiliation, venue, code links).
