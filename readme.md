<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/papers-453-0EA5E9?style=flat-square" alt="Papers">
...
All 453 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:

**→ http://awesomebio.webioinfo.top/**

- 🌟 [AI Agents](http://awesomebio.webioinfo.top/#ai-agents) — 144 papers
- 🎯 [Foundation models](http://awesomebio.webioinfo.top/#foundation-models) — 145 papers
...
- 📚 [Reviews](http://awesomebio.webioinfo.top/#reviews) — 71 papers

Machine-readable data: [`docs/data.json`](docs/data.json) — 453 entries with full metadata (team, affiliation, venue, code links).
