...
All 351 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:
...
Machine-readable data: [`docs/data.json`](docs/data.json) — 351 entries with full metadata (team, affiliation, venue, code links).
