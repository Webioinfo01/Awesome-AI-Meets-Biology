<div align="center">
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/papers-450-0EA5E9?style=flat-square" alt="Papers">
...
All 450 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:
...
Machine-readable data: [`docs/data.json`](docs/data.json) — 450 entries with full metadata (team, affiliation, venue, code links).
