...
All 411 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:

**→ http://awesomebio.webioinfo.top/**

- 🌟 [AI Agents](http://awesomebio.webioinfo.top/#ai-agents) — 131 papers
- 🎯 [Foundation models](http://awesomebio.webioinfo.top/#foundation-models) — 131 papers
- 💾 [Databases/Simulation](http://awesomebio.webioinfo.top/#databases) — 35 papers
- 📊 [Benchmarks](http://awesomebio.webioinfo.top/#benchmarks) — 50 papers
- 📚 [Reviews](http://awesomebio.webioinfo.top/#reviews) — 64 papers

Machine-readable data: [`docs/data.json`](docs/data.json) — 411 entries with full metadata (team, affiliation, venue, code links).
