...
All 390 papers live on the [website](http://awesomebio.webioinfo.top/) — with instant search across papers, teams, domains and venues, category tabs, and per-year statistics:

**→ http://awesomebio.webioinfo.top/**

- 🌟 [AI Agents](http://awesomebio.webioinfo.top/#ai-agents) — 122 papers
- 🎯 [Foundation models](http://awesomebio.webioinfo.top/#foundation-models) — 122 papers
- 💾 [Databases/Simulation](http://awesomebio.webioinfo.top/#databases) — 32 papers
- 📊 [Benchmarks](http://awesomebio.webioinfo.top/#benchmarks) — 49 papers
- 📚 [Reviews](http://awesomebio.webioinfo.top/#reviews) — 63 papers

Machine-readable data: [`docs/data.json`](docs/data.json) — 390 entries with full metadata (team, affiliation, venue, code links).
